...
const ACHIEVEMENTS: Achievement[] = [
  ...
  {
    id: "cpu_components_master",
    type: "concept_mastered",
    title: "Conocedor de Componentes",
    description: "Comprende los componentes principales de la CPU",
    icon: faCogs,
    requirement: 1,
    current: 0,
    unlocked: false,
  ...
  },
  {
    ...
    description: "Domina los diferentes tipos de registros",
    icon: faMicrochip,
    requirement: 1,
    current: 0,
    unlocked: false,
...
const LEARNING_LEVELS: LearningLevel[] = [
  {
    id: "beginner",
    name: "Principiante",
    description: "Conceptos básicos: CPU, registros y memoria",
    concepts: ["cpu-components", "registers", "memory"],
    requiredPoints: 0,
    unlocked: true,
    completed: false,
  },
  {
    id: "intermediate",
    name: "Intermedio",
    description: "Operaciones aritméticas y ciclo de instrucción",
    concepts: ["alu", "bus"],
    requiredPoints: 50,
    unlocked: false,
    completed: false,
