import { faBook, faEye, faLightbulb, faPlay, faTrophy } from "@fortawesome/free-solid-svg-icons";
...
export const EducationalMenu = memo(
  ({ isOpen = false, onClose, onShowProgress }: EducationalMenuProps) => {
                    ...
                    {item.id === "tutorials" ? (
                      <div>
                        ...
                        >
                          <FontAwesomeIcon
                            icon={item.icon}
                            className={clsx("text-lg", item.color)}
                          />
