...
- **🧠 Memoria de Control**: Visualiza microinstrucciones y microoperaciones para cada instrucción
- **⚙️ Secuenciador**: Muestra las fases del ciclo de instrucción y señales de control
- **🎯 Interactividad**: Botones en el decodificador para activar cada componente
- **📚 Educativo**: Explicaciones detalladas y conceptos clave de arquitectura
